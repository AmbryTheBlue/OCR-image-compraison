...
\subsection{FAIR}
	...
	\begin{figure}[h!]
	\includegraphics[scale=0.17]{obrazky/grayscale}
	\centering
	...
	\begin{figure}[h]
	\includegraphics[scale=0.17]{obrazky/threshold_mean(9,4)}
	\centering
	...
	\begin{figure}[h]
	\includegraphics[scale=0.17]{obrazky/threshold_gauss(9,4)}
	\centering
	...
	\begin{figure}[h!]
	\includegraphics[scale=0.17]{obrazky/threshold_gauss(15,2)}
	\centering
	...
	\end{figure}
		...
		\begin{figure}[h!]
	\includegraphics[scale=0.17]{obrazky/threshold_otsu}
	\centering
	...
	\begin{figure}[h]
	\includegraphics[scale=0.17]{obrazky/blur_avg(5,5)}
	\centering
	...
	\begin{figure}[h!]
	\includegraphics[scale=0.17]{obrazky/blur_avg(5,5)-threshold_gauss(15,2)}
	\centering
	...
	\begin{figure}[h!]
	\includegraphics[scale=0.17]{obrazky/resize}
	\centering
